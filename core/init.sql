...
INSERT INTO core.SKILLS_TYPE
(CODE, DESCRIPTION)
VALUES('STND', 'ESTANDAR');

INSERT INTO core.SKILLS
(ID, SKILL_TYPE, NAME, DESCRIPTION)
VALUES(1, 'STND', 'GUARDIA SIMPLE', 'ANULA EL MOVIMIENTO LOS DOS PRÓXIMOS TURNOS, PERO AUMENTA LA DEFENSA FÍSICA Y MÁGICA +1');

INSERT INTO core.SKILLS_ENEMIES
(SKILL_ID, ENEMY_ID, USE_LIMIT)
VALUES(1, 1, 1);

INSERT INTO core.NODES_CONNECTIONS (ID,NAME,UP_NODE_ID,UP_DISTANCE,RIGHT_NODE_ID,RIGHT_DISTANCE,DOWN_NODE_ID,DOWN_DISTANCE,LEFT_NODE_ID,LEFT_DISTANCE) VALUES
	 (1,'TORRE HELADA',NULL,NULL,NULL,NULL,2,5,NULL,NULL),
	 (2,'RÍO SIGRIX',1,5,NULL,NULL,3,6,NULL,NULL),
	 (3,'RÍO DEL HACHA ROTA',2,6,5,8,6,7,4,4),
	 (4,'CUEVA DEL DRAGÓN HELADO',NULL,NULL,3,4,NULL,NULL,NULL,NULL),
	 (5,'CIELO NEGRO',10,10,NULL,NULL,11,7,3,8),
	 (6,'LLANURA HELADA',3,7,9,4,16,7,7,4),
	 (7,'SALEM',8,4,6,4,NULL,NULL,NULL,NULL),
	 (8,'MANSIÓN VAYNE',NULL,NULL,NULL,NULL,7,4,NULL,NULL),
	 (9,'CAMPAMENTO DE LOS ARROWS',NULL,NULL,NULL,NULL,NULL,NULL,6,4),
	 (10,'CUEVA DEL YETI',NULL,NULL,NULL,NULL,5,10,NULL,NULL);
INSERT INTO core.NODES_CONNECTIONS (ID,NAME,UP_NODE_ID,UP_DISTANCE,RIGHT_NODE_ID,RIGHT_DISTANCE,DOWN_NODE_ID,DOWN_DISTANCE,LEFT_NODE_ID,LEFT_DISTANCE) VALUES
	 (11,'CAMINO DE GREEN TOWN',5,7,12,3,13,7,NULL,NULL),
	 (12,'GREEN TOWN',NULL,NULL,NULL,NULL,NULL,NULL,11,3),
	 (13,'CAMINO DEL NORTE',11,7,15,6,40,5,14,6),
	 (14,'ROCA ZARPA',NULL,NULL,13,6,NULL,NULL,NULL,NULL),
	 (15,'RUINAS DE PUERTO TRISTE',NULL,NULL,NULL,NULL,NULL,NULL,13,6),
	 (16,'RÍO DEL MERCENARIO',6,7,NULL,NULL,17,7,NULL,NULL),
	 (17,'LA ENCRUCIJADA',16,7,NULL,NULL,39,11,18,6),
	 (18,'CARRETERA REAL',19,4,17,6,34,8,20,5),
	 (19,'MINAS DE MORG',NULL,NULL,NULL,NULL,18,4,NULL,NULL),
	 (20,'VILLA DE LA PLATA',NULL,NULL,18,5,NULL,NULL,21,4);
INSERT INTO core.NODES_CONNECTIONS (ID,NAME,UP_NODE_ID,UP_DISTANCE,RIGHT_NODE_ID,RIGHT_DISTANCE,DOWN_NODE_ID,DOWN_DISTANCE,LEFT_NODE_ID,LEFT_DISTANCE) VALUES
	 (21,'PUENTE DE PIEDRA',NULL,NULL,20,4,22,8,24,4),
	 (22,'TIERRAS DEL COMERCIO',21,8,34,4,36,7,23,4),
	 (23,'FARO ARGENTA',NULL,NULL,22,4,NULL,NULL,NULL,NULL),
	 (24,'RUTA DE LOS FORAJIDOS',25,3,21,4,26,4,27,5),
	 (25,'TORRE DE LA ESPADA',NULL,NULL,NULL,NULL,24,3,NULL,NULL),
	 (26,'CAMPAMENTO DE MERCADERES AMBULANTES',24,4,NULL,NULL,NULL,NULL,NULL,NULL),
	 (27,'LLANURAS DEL SAQUEO',NULL,NULL,24,5,28,3,29,5),
	 (28,'PUERTO ESPINA',27,3,NULL,NULL,NULL,NULL,NULL,NULL),
	 (29,'DESCANSO DEL AHOGADO',NULL,NULL,NULL,NULL,31,4,30,3),
	 (30,'CAMPAMENTO',NULL,NULL,29,3,NULL,NULL,31,3);
INSERT INTO core.NODES_CONNECTIONS (ID,NAME,UP_NODE_ID,UP_DISTANCE,RIGHT_NODE_ID,RIGHT_DISTANCE,DOWN_NODE_ID,DOWN_DISTANCE,LEFT_NODE_ID,LEFT_DISTANCE) VALUES
	 (31,'ARBOLEDA DE COSTA GUARDIA',29,4,33,4,32,4,30,3),
	 (32,'COSTA GUARDIA',31,4,NULL,NULL,NULL,NULL,NULL,NULL),
	 (33,'PUERTO DE LOS CONTRABANDISTAS',NULL,NULL,NULL,NULL,NULL,NULL,31,4),
	 (34,'EL PARADERO DE LAS NINFAS',18,8,68,11,35,3,22,4),
	 (35,'CAMPAMENTO WHITEWELL',34,3,NULL,NULL,NULL,NULL,NULL,NULL),
	 (36,'PRADOS VERDES',22,7,NULL,NULL,37,6,NULL,NULL),
	 (37,'CAMPAMENTO SANCTO SANTORUM',36,6,72,7,96,13,38,3),
	 (38,'I LEGIÓN',NULL,NULL,37,3,NULL,NULL,NULL,NULL),
	 (39,'RÍO GRIS',17,11,64,3,65,5,NULL,NULL),
	 (40,'VALLE AGRESTE',13,5,41,4,42,7,NULL,NULL);
INSERT INTO core.NODES_CONNECTIONS (ID,NAME,UP_NODE_ID,UP_DISTANCE,RIGHT_NODE_ID,RIGHT_DISTANCE,DOWN_NODE_ID,DOWN_DISTANCE,LEFT_NODE_ID,LEFT_DISTANCE) VALUES
	 (41,'ORO VERDE',NULL,NULL,NULL,NULL,NULL,NULL,40,4),
	 (42,'GRAN PRADERA',40,7,43,3,44,6,NULL,NULL),
	 (43,'GRANJA DE FRANK',NULL,NULL,44,6,NULL,NULL,42,3),
	 (44,'CAMINO A ESPERANTIA',42,6,45,7,49,8,64,7),
	 (45,'CAMINO A LUCERO',46,4,48,5,47,3,44,7),
	 (46,'LUCERO',NULL,NULL,NULL,NULL,45,4,NULL,NULL),
	 (47,'RESTOS DEL CIMERIO',45,3,NULL,NULL,NULL,NULL,NULL,NULL),
	 (48,'CAMPAMENTO DE NÓMADAS',NULL,NULL,NULL,NULL,49,6,45,6),
	 (49,'GRAN BOSQUE REAL',44,8,48,6,51,5,50,5),
	 (50,'MONASTERIO DE BEATRIX DE SIMA',NULL,NULL,49,5,NULL,NULL,NULL,NULL);
INSERT INTO core.NODES_CONNECTIONS (ID,NAME,UP_NODE_ID,UP_DISTANCE,RIGHT_NODE_ID,RIGHT_DISTANCE,DOWN_NODE_ID,DOWN_DISTANCE,LEFT_NODE_ID,LEFT_DISTANCE) VALUES
	 (51,'CAMINO AL SOLSTICIO',49,5,NULL,NULL,53,4,52,4),
	 (52,'CONSAGRADA',NULL,NULL,51,4,NULL,NULL,NULL,NULL),
	 (53,'PASO DEL ROBLE',51,4,54,5,55,3,NULL,NULL),
	 (54,'RUINAS DE LA ANTIGUA EZIA',NULL,NULL,NULL,NULL,NULL,NULL,53,5),
	 (55,'ENCRUCIJADA DE LA VIUDA',53,3,56,4,60,4,57,6),
	 (56,'TORRE DEL AJUSTICIADO',NULL,NULL,NULL,NULL,NULL,NULL,55,7),
	 (57,'LLANURA DEL MINERO',58,3,55,6,NULL,NULL,59,6),
	 (58,'MINA DE KAZUL',NULL,NULL,NULL,NULL,57,3,NULL,NULL),
	 (59,'GUARDIÁN',NULL,NULL,57,6,NULL,NULL,NULL,NULL),
	 (60,'SOLSTICIO',55,4,NULL,NULL,63,5,61,7);
INSERT INTO core.NODES_CONNECTIONS (ID,NAME,UP_NODE_ID,UP_DISTANCE,RIGHT_NODE_ID,RIGHT_DISTANCE,DOWN_NODE_ID,DOWN_DISTANCE,LEFT_NODE_ID,LEFT_DISTANCE) VALUES
	 (61,'CASTILLO DE HELSING',NULL,NULL,60,7,NULL,NULL,62,5),
	 (62,'BOCA AL INFERNUS',NULL,NULL,61,5,NULL,NULL,NULL,NULL),
	 (63,'PUERTO TRISTE',60,5,NULL,NULL,70,5,NULL,NULL),
	 (64,'ESPERANTIA',NULL,NULL,44,7,NULL,NULL,39,3),
	 (65,'SENDERO PELIGROSO',39,5,99,4,68,3,66,3),
	 (66,'ALDEA DEL TOPO',NULL,NULL,65,3,NULL,NULL,NULL,NULL),
	 (68,'BOSQUE DE LOS LADRONES',65,3,NULL,NULL,69,3,34,11),
	 (69,'CAMPAMENTO DE LEÑADORES',68,3,NULL,NULL,NULL,NULL,NULL,NULL),
	 (70,'GRANJA DE VALIANT',63,5,NULL,NULL,NULL,NULL,72,6),
	 (72,'SANCTO SANTORUM',NULL,NULL,70,6,73,5,37,7);
INSERT INTO core.NODES_CONNECTIONS (ID,NAME,UP_NODE_ID,UP_DISTANCE,RIGHT_NODE_ID,RIGHT_DISTANCE,DOWN_NODE_ID,DOWN_DISTANCE,LEFT_NODE_ID,LEFT_DISTANCE) VALUES
	 (73,'ENCRUCIJADA DEL SUR',72,5,75,4,76,6,74,7),
	 (74,'MINAS DE KOZ',NULL,NULL,73,7,NULL,NULL,NULL,NULL),
	 (75,'PUERTO ALTO',NULL,NULL,NULL,NULL,NULL,NULL,73,4),
	 (76,'BOSQUE VERDE DEL SUR',73,6,77,4,78,7,NULL,NULL),
	 (77,'RUINAS DE COLOSA',NULL,NULL,NULL,NULL,NULL,NULL,76,4),
	 (78,'CAMINO A VANGUARDIA',76,7,NULL,NULL,79,6,NULL,NULL),
	 (79,'LLANURAS DEL PROGRESO',78,6,81,5,85,5,80,4),
	 (80,'VANGUARDIA',NULL,NULL,79,4,NULL,NULL,NULL,NULL),
	 (81,'CAMINO DEL OLVIDO',NULL,NULL,82,4,83,4,79,5),
	 (82,'YACIMIENTO DE VERMEN',NULL,NULL,NULL,NULL,NULL,NULL,81,4);
INSERT INTO core.NODES_CONNECTIONS (ID,NAME,UP_NODE_ID,UP_DISTANCE,RIGHT_NODE_ID,RIGHT_DISTANCE,DOWN_NODE_ID,DOWN_DISTANCE,LEFT_NODE_ID,LEFT_DISTANCE) VALUES
	 (83,'PUEBLO DE LOS INGENIEROS',81,4,NULL,NULL,84,4,NULL,NULL),
	 (84,'PUERTA DEL OLVIDO',83,4,NULL,NULL,NULL,NULL,NULL,NULL),
	 (85,'LA CUENCA DEL CASTOR',79,5,NULL,NULL,86,5,87,7),
	 (86,'GRANJA DE KENT',85,5,NULL,NULL,NULL,NULL,NULL,NULL),
	 (87,'CIÉNAGA DE LAS BRUJAS',89,6,85,7,88,6,90,6),
	 (88,'DEFENSA DE HANAN',87,6,NULL,NULL,NULL,NULL,NULL,NULL),
	 (89,'LA CASA DE LA ANCIANA',NULL,NULL,NULL,NULL,87,6,90,3),
	 (90,'BOSQUE MALDITO',91,6,89,3,NULL,NULL,NULL,NULL),
	 (91,'CRUCE DE CAMINOS DEL BOSQUE MALDITO',94,5,93,3,90,6,92,6),
	 (92,'YACIMIENTO DE LA VERGEL',NULL,NULL,91,6,NULL,NULL,NULL,NULL);
INSERT INTO core.NODES_CONNECTIONS (ID,NAME,UP_NODE_ID,UP_DISTANCE,RIGHT_NODE_ID,RIGHT_DISTANCE,DOWN_NODE_ID,DOWN_DISTANCE,LEFT_NODE_ID,LEFT_DISTANCE) VALUES
	 (93,'ALDEA DE LA BRUMA',NULL,NULL,NULL,NULL,NULL,NULL,91,3),
	 (94,'ARBOLEDA COSTERA',96,7,NULL,NULL,91,5,95,3),
	 (95,'PUERTO AZUL',NULL,NULL,94,3,NULL,NULL,NULL,NULL),
	 (96,'CAMINO DE ZARZAS',37,13,97,3,94,7,98,3),
	 (97,'CAMPAMENTO DE LAS MONTAÑAS',NULL,NULL,NULL,NULL,NULL,NULL,96,3),
	 (98,'CASA GRIS',NULL,NULL,96,3,NULL,NULL,NULL,NULL),
	 (99,'MINA DE OKTAR',NULL,NULL,NULL,NULL,NULL,NULL,65,4);
