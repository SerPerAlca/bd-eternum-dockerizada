...
CREATE TABLE SCENES (
  ...
  NEXT_SCENE_ID bigint DEFAULT NULL,
  SCENE_TYPE varchar(4) COLLATE utf8mb4_unicode_ci NOT NULL,
  CHAPTER_ID int NOT NULL,
  SCENE_TEXT text COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  SCENE_LOCATION varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  RESOURCE_ID varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (ID),
  KEY fk_scene_next (NEXT_SCENE_ID),
  KEY fk_scene_type (SCENE_TYPE),
  KEY fk_scene_chapter (CHAPTER_ID),
  CONSTRAINT fk_scene_chapter FOREIGN KEY (CHAPTER_ID) REFERENCES CHAPTERS (ID),
  CONSTRAINT fk_scene_next FOREIGN KEY (NEXT_SCENE_ID) REFERENCES SCENES (ID),
  CONSTRAINT fk_scene_type FOREIGN KEY (SCENE_TYPE) REFERENCES SCENE_TYPES (CODE)
...
VALUES(1, 2, 'MAIN', 999, 'Despertáis encadenados en la bodega de un barco. El suelo rezuma salitre y podredumbre. No estáis solos. Hay más cuerpos encadenados, sombras que murmuran o gimen. Los hombres de arriba hablan con acentos duros, entre risas roncas y escupitajos. Huelen a sangre, sudor seco y cuero viejo. Piratas, quizá. Traficantes de esclavos, casi seguro. Mencionan el norte, las costas de las Barbarians, la vía más rápida. Un nuevo Señor ha comenzado a pagar bien por carne viva. Y vosotros, los héroes, sois ahora mercancía. 
 ...
 Y luego, nada.', NULL, NULL, 'En un barco esclavista', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
...
VALUES(3, NULL, 'MAIN', 1, 'El engaño dura apenas unos pasos. 
 ...
 No podréis huir, no podréis separaros. Hasta romper el vínculo —si es que eso es posible— estaréis condenados a caminar juntos. Y cada dirección que elijáis no será un camino, sino una sentencia.', NULL, NULL, '???', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
...
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(11, 12, 'MAIN', 1, 'Horas después desembarcáis en un islote desolado. En su centro, un torreón de piedra se eleva con varios pisos de altura, coronado por cañones que vigilan el horizonte como ojos hambrientos. Sois empujados al interior entre golpes y escarnios. El patio central es un pozo de sombras: celdas inclinadas rodean el abismo, dejando ver miembros huesudos que asoman entre barrotes. Y en medio, un patíbulo improvisado: un hombre sucio y desnutrido escucha sus delitos de boca de un hombre ataviado con una gabardina blanca que sujeta un pergamino. Varios soldados preparan al condenado para su ejecución.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(12, 13, 'MAIN', 1, 'El hombre de la gabardina, al que llaman Juez, pregunta al condenado si desea pronunciar sus últimas palabras. La voz del reo tiembla: pide perdón a su familia por todo lo robado en nombre del hambre, a su madre por la deshonra y a su hijo por no… La soga se tensa antes de que termine. El cuerpo se sacude, la lengua rota inunda de sangre su boca, y su despedida se pierde en un gorgoteo. Los soldados estallan en carcajadas. Han cortado la voz del moribundo en el instante más amargo. El dolor ajeno se transforma en espectáculo. Sois situados frente al Juez. ', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(13, NULL, 'MAIN', 1, 'Juez: Dicen que os hallaron vagando sin permiso real por estas tierras… ¿Qué sois, piratas, contrabandistas, esclavistas?', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(14, 16, 'MAIN', 1, 'Juez: ¡Por supuesto! Queda aclarado todo entonces... soldados, liberen a los prisioneros. Es obvio de que se trata de un error... ', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(15, 16, 'MAIN', 1, 'Juez: Tenéis razon sir. Me disculpo en nombre de las fuerzas del reino. No podíamos correr riesgos. ¡Guardias, soltad a los prisioneros y preparenles un estofado y un buen baño de agua caliente!', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(16, 17, 'MAIN', 1, 'Sois golpeados por los guardias en la espalda y en las piernas haciéndoos caer de rodillas.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(17, 18, 'MAIN', 1, 'Juez: El delito de piratería está claro. No voy a perder el tiempo con alimañas como vosotros. Guardias, tirad el cuerpo de ese al foso y preparad a estos piratas para ser colgados.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(18, 19, 'MAIN', 1, 'Sois arrastrados entre gritos y golpes, cuando las puertas del patio se abren de nuevo. Un hombre de unos sesenta años entra, vestido con un brial blanco y dorado. Lo escoltan hombres sin camisa, cubiertos de cicatrices frescas y viejas, marcas de látigos y hierros. El juez acude a su encuentro haciendo una reverencia y besando un anillo negro y dorado de su mano. El Juez se dirige a él como Santo Inquisidor San Ilirio.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(19, 20, 'MAIN', 1, 'Juez: No le esperábamos, su santidad. ¿A qué debemos tal honor?', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(20, 21, 'MAIN', 1, 'San Ilirio: Van a traer a un prisionero que exige mi atención. Darius El Sanguinario.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(21, 22, 'MAIN', 1, 'Juez: ¡Imposible! San Ilirio: Nada es imposible bajo la protección de los Ez. Me adelanté a su escolta para que todo esté listo para el interrogatorio. —¿Y estos? Los ojos del Inquisidor se clavan en vosotros, como si ya midiera vuestra culpa.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(22, 23, 'MAIN', 1, 'Juez: Simples piratas, su santidad. No pierda el tiempo con ellos. Ahora mismo los colgaremos y prepararemos la llegada del Sanguinario El Juez hace un gesto seco; los guardias obedecen y avanzan hacia el patíbulo. Antes de que puedan apresurar el rito, un guardia irrumpe jadeando con noticias desde el muelle.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(23, 24, 'MAIN', 1, 'San Ilirio: Olvídélo. No hay tiempo. Metan a los prisioneros en una celda; ya habrá ocasión para ajusticiarlos después. Los hombres se detienen, contrariados. En lugar de la horca, sois empujados hasta una celda húmeda de la planta baja, cercana al patíbulo donde ibais a ser ahorcados apenas un minuto antes.. ', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(24, 25, 'MAIN', 1, 'Una docena de soldados entra escoltando a un hombre ensangrentado. Se trata de un hombre joven, apuesto, con melena y perilla bien cuidadas. Lo colocan frente al Inquisidor y al Juez. Los escoltas se alinean tras él, tensos, preparados para abalanzarse si hace el menor movimiento. ', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(25, 26, 'MAIN', 1, 'Darius: Bueno… ya estamos aquí. Lo dice con media sonrisa, sin apartar la mirada del Inquisidor. El Juez le cruza el rostro con un revés seco. Darius escupe sangre a un lado y vuelve a fijar sus ojos en San Ilirio, imperturbable.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(26, 27, 'MAIN', 1, 'San Ilirio: Tu bravuconería es admirable. Traicionado por los tuyos, cazado como un animal… y aún sonríes Darius: Dicen que lo último que se pierde es la sonrisa - ¿O era la esperanza?', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(27, 28, 'MAIN', 1, 'San Ilirio: Puedes renunciar a la esperanza… Tras un par de días de interrogatorio nos dirás todo lo que necesito para acabar contigo y los tuyos', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(28, 29, 'MAIN', 1, 'Una campana estalla en lo alto de la fortaleza. Los soldados se miran entre sí, inquietos. El Juez ruge, exige respuestas. Un guardia aparece jadeando: un barco del aire no identificado se lanza directo contra la Roca Negra. Los cañones retumban haciendo temblar los muros. Un impacto sacude la prisión varios pisos arriba; bloques de piedra se desploman en el patio y revientan contra el suelo. Dos soldados quedan reducidos a carne bajo los escombros. ', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(29, 30, 'MAIN', 1, 'Juez: ¡Meted al prisionero en una celda! ¡Rápido! ¡Quiero ese barco en el fondo del mar ya! (Volviéndose hacia el Inquisidor) —Santidad, debe ponerse a cubier… ', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(30, 31, 'MAIN', 1, 'La voz se quiebra. Donde estaba San Ilirio sólo queda una montaña de ruinas. Entre la roca asoma una mano con un anillo negro y dorado. El Juez ordena despejar el lugar; algunos hombres se quedan a excavar, otros os escoltan hasta una celda del patio, contigua a la del Sanguinario. El Juez desaparece tras una puerta con la mayor parte de sus hombres, dejando el aire denso de polvo, sangre y escombros', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(31, 32, 'MAIN', 1, 'La celda del Sanguinario, a diferencia de la vuestra, tiene una abertura minúscula a modo de ventana. Darius se arranca un diente, lo hace crujir entre los dedos y lo asoma al exterior. Un humo azul brota de su mano, se retuerce y asciende en una columna hacia el cielo. Tras unos segundos, vuelve a meter su mano y retrocede hasta tocar los barrotes del otro extremo de la celda con su espalda. Se gira hacia vosotros.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(32, NULL, 'MAIN', 1, 'Darius: Sí yo fuera vosotros, me apartaría de esa pared. Narrador: Dice señalando la pared exterior de vuestra celda.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(33, 9999, 'MAIN', 1, 'Desoís la advertencia y permanecéis junto al muro. Un cañonazo revienta la piedra en un estruendo brutal. El impacto os despedaza al instante. Carne y hueso cubren la celda. Vuestra historia termina aquí.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(34, 35, 'MAIN', 1, 'Hacéis caso y retrocedéis hacia la pared interior. Segundos después, el cañón revienta la muralla y abre una brecha que comunica ambas celdas. El aire se llena de polvo y cascotes. Darius avanza hasta la abertura y contempla el exterior: el barco del aire bombardea la prisión mientras sobrevuela las aguas. El Sanguinario se prepara para saltar al terreno, pero antes se gira hacia vosotros.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(35, 36, 'MAIN', 1, 'Darius: Ante vosotros se presentan dos caminos: — Podéis seguirme y escapar. Llevaréis una vida de proscritos y seréis perseguidos hasta el final de vuestros días en esta tierra... o podéis quedaros y esperar la soga. — Yo lo tengo claro. Darius se lanza al vacío y desaparece de vuestra vista.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(36, 37, 'MAIN', 1, 'Saltáis al exterior y os encontráis con Darius, quien parece haberos esperado. Él os indica que lo sigáis. El barco del aire sigue intercambiando disparos con los cañones de la prisión, aunque la distancia y la pericia del piloto evitan que los proyectiles acierten. Avanzáis unos metros y un enano de barba blanca se interpone en vuestro camino', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(37, 38, 'MAIN', 1, 'Enano: ¡Pardiez, Darius! Pensé que no saldrías con vida de ahí. Debes ser el hombre más afortunado del mundo', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(38, 39, 'MAIN', 1, 'Darius: ¡Zornak, amigo! Lo que voy a ser es el hombre más endeudado si derriban el barco de Noca. —Debemos darnos prisa antes de que reparen mi ausencia. Ese barco no aguantará mucho más — ¿Has traído armas? ', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(39, 40, 'MAIN', 1, 'Zornak: Sí. Traje todas las que pediste... aunque no sé para qué querías tantas. El enano despliega una manta: armas de todo tipo, muchas oxidadas o desgastadas, pero todas potencialmente útiles. Zornak: Por cierto, ¿Estos quienes son? Dice el enano centrando su mirada en vosotros.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(40, NULL, 'MAIN', 1, 'Darius: Digamos que... compañeros de infortunios. — Bien. Coged un arma. La necesitaremos. La distracción del cielo no durará mucho.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(41, 42, 'SPEC', 1, 'Os armáis en silencio, conscientes de que lo que viene no admite errores. El metal suena apagado, como si incluso las armas temieran el combate.', NULL, NULL, 'La Roca Negra', 'VIDEO_WEAPON_SELECTION');
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(42, 43, 'MAIN', 1, 'Zornak: Debemos darnos prisa. He ocultado una bote en el extremo sur de la isla. No tardarán en encontrarlo… o en encontrarnos a nosotros. 
 ...
 Darius: Entonces no perdamos más tiempo.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(43, 44, 'MAIN', 1, 'Una explosión sacude los cielos. Todos alzan la vista: el barco del aire sigue intercambiando fuego con las defensas de la prisión. Su piloto maniobra con maestría, rodeando la fortaleza mientras esquiva proyectiles que arrancan trozos de piedra del torreón. 
 ...
 Zornak: Vas a deberle una muy grande a Jok. ', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(44, 45, 'MAIN', 1, 'Un disparo certero alcanza las hélices centrales del navío. El barco se inclina hacia babor, pierde altura con rapidez y, en apenas unos segundos, se estrella contra el puerto de la prisión. La explosión levanta una columna de humo negro que ennegrece el cielo. 
 ...
 Darius: Demasiado grande…', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(45, 46, 'MAIN', 1, 'El grupo corre junto a Darius y Zornak. Sin el barco del aire, saben que su fuga no tardará en ser descubierta. Avanzan por el flanco oriental de la isla, ocultándose entre rocas y árboles escasos. La campana de la prisión no deja de sonar. Ya los están buscando. 
 ...
 Guardia:¡Alto! No iréis a ninguna parte, bellacos. Rendíos y moriréis con dignidad. ', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(46, 47, 'MAIN', 1, 'Darius: Me temo que no. Hoy no es el día de mi muerte. 
 ...
 Darius y el enano se lanzan contra los guardias. El resto se abalanza sobre los héroes. El acero choca y la huida se convierte en sangre.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(47, 48, 'FGHT', 1, '(COMBATE CONTRA 3 GUARDIAS)', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(48, 49, 'MAIN', 1, 'El suelo está empapado de sangre. Un barro espeso y oscuro cubre las piedras, y el aire huele a hierro y muerte. Darius recorre al grupo con la mirada, uno por uno, comprobando que siguen con vida. Cuando lo confirma, una sonrisa dura, casi animal, se dibuja en su rostro. Ha encontrado aliados útiles… y en tiempos como estos, eso vale más que cualquier juramento. 
 ...
 Una lluvia de fuego y flechas cae sobre ellos, silbando en el aire como serpientes furiosas.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
...
VALUES(51, 52, 'MAIN', 1, 'Uno a uno, todos descienden por la escarpada ladera sur de la isla, fuera de la vista de la muralla fortificada de la prisión. 
 ...
 El sendero es poco más que una cicatriz en la roca, estrecho y traicionero, bordeando el acantilado. Pegados a la pared, avanzan sin mirar abajo. Un paso en falso los haría caer y quedar destrozados contra las rocas del fondo. La suerte, esta vez, no los abandona.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(52, 53, 'MAIN', 1, 'Cuando por fin divisan el bote, varias figuras se interponen en su camino. 
 ...
 El Juez de la prisión avanza un paso, acompañado por cuatro guardias.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(53, 54, 'MAIN', 1, 'Darius: ¿Así que no vas a dejarme en paz nunca, capitán? 
 ...
 Darius: Es curioso que seas tú quien me llame así. Tú, que pasaste por la espada a hombres, mujeres y niños en Puerto Triste. Dime… ¿puedes dormir después de aquello?', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(54, 55, 'MAIN', 1, 'El rostro del Juez se endurece. Sus ojos se vuelven de hielo. 
 ...
 Darius: Capitán, como ya les he dicho a tus hombres… hoy no es el día de mi muerte.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(55, 56, 'MAIN', 1, 'El mundo estalla. 
 ...
 En apenas unos segundos, los guardias yacen en el suelo, exhalando sus últimos alientos. Zornak queda frente al antiguo capitán, respirando como una bestia acorralada.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(56, 57, 'MAIN', 1, 'Juez: Ven, hereje. Daré a Gladius de beber tu sangre. 
 ...
 Darius: ¡NOOOO! ', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(57, 58, 'MAIN', 1, 'Un hilo de humo se eleva del cañón de la pistola del Juez. Sonríe. No es triunfo, es odio satisfecho. Deja caer el arma descargada y desenvaina un sable peculiar: tiene el mango negro con detalles dorados. El mismo sable que usan en la Guardia Del Mar para matar bárbaros. 
 ...
 Unas boleadoras silban en el aire y se cierran sobre el torso de Darius. Cae con fuerza. Las cuerdas lo aprisionan, atrapando sus brazos.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(58, 59, 'MAIN', 1, 'Juez: Me gustaría matarte aquí mismo, pero aún hay información que sacarte. 
 ...
 Juez: En cambio vosotros, no llegareis vivos al juicio.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(59, 60, 'FGHT', 1, 'Combate contra el Juez de Roca Negra', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(60, NULL, 'MAIN', 1, 'Con el Juez abatido, el grupo se apresura a desatar a Darius. Las cuerdas caen al suelo, pero él no pierde un segundo. Corre hacia el cuerpo de Zornak. 
 ...
 Disparos de arcabuz resuenan en la distancia, secos y urgentes. Cada estampido empuja al grupo hacia el bote. Gritan. Apremian. El tiempo se agota.', NULL, NULL, 'La Roca Negra', NULL);
INSERT INTO book.SCENES
(ID, NEXT_SCENE_ID, SCENE_TYPE, CHAPTER_ID, SCENE_TEXT, AUDIO_PATH, MUSIC_PATH, SCENE_LOCATION, RESOURCE_ID)
VALUES(9999, NULL, 'END', 9999, 'THE END', NULL, NULL, 'THE END', NULL);
